...
export default (fnc) => {
   return (
      <View style={{ justifyContent: 'center', padding: 10 }}>
         ...
         <TouchableOpacity onPress={()=>fnc()} style={{ width: '50%', height: 40, justifyContent: 'center', alignSelf: 'center', backgroundColor: '#ffa31a', borderRadius: 5, marginBottom: 90 }}><Text style={{ alignSelf: 'center', justifyContent: 'center', color: 'white', fontWeight: '600', fontSize: 20 }}>Okudum, kapat</Text></TouchableOpacity>
